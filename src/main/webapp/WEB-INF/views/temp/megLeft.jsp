	...
	margin-top: 15%;
			...
			<div id="msg_left">
				<ul>
					...
					<li><a href="<%=application.getContextPath() %>/message/SeadList?curPage=1&find=&search=sendId&sendId=${member.id}&board=Send" style="text-decoration: none !important;">보낸쪽지함</a></li>
